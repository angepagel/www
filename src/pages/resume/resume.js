                  ...
                  <Row>
                    ...
                    <Col xs="12" sm="7">
                      <div className="line">
                        ...
                        <div className="infos">
                          <span><i className="material-icons">event_note</i> Sept. 2018 - En cours</span>
                          <br/>
                      ...
                      <div className="line">
                        ...
                        <div className="infos">
                          <span><i className="material-icons">event_note</i> Sept. 2017 - Juin 2019</span>
                          <br/>
                      ...
                      <div className="line">
                        ...
                        <div className="infos">
                          <span><i className="material-icons">event_note</i> Sept. 2015 - Juin 2017</span>
                          <br/>
