              ...
              <Col className="mx-auto" md="12" lg="8">
                ...
                <section id="download">
                  <Row className="text-center">
                    <Col xs="12" sm="6">
                      <a rel="noopener noreferrer" className="main" href="https://www.angepagel.fr/uploads/CV_Ange_PAGEL_FR.pdf" target="_blank">
                        <DownloadCloudIcon/>
                        <FormattedMessage id="Resume.download.fr" />
                      </a>
                    </Col>
                    <Col xs="12" sm="6">
                      <a rel="noopener noreferrer" className="main" href="https://www.angepagel.fr/uploads/CV_Ange_PAGEL_EN.pdf" target="_blank">
                        <DownloadCloudIcon/>
                        <FormattedMessage id="Resume.download.en" />
                      </a>
                    </Col>
                  </Row>
                </section>
                    ...
                    <Col xs="12" sm="7">
                      <div className="line">
                        ...
                        <div className="infos">
                          ...
                          <span>
                            <MapPinIcon/>
                            <a rel="noopener noreferrer" target="_blank" href="https://goo.gl/maps/SyBFEGsFhrW4uZM37">Grenoble INP - Ensimag</a>
                          </span>
                        </div>
                      ...
                      <div className="line">
                        ...
                        <div className="infos">
                          ...
                          <span>
                            <MapPinIcon/>
                            <a rel="noopener noreferrer" target="_blank" href="https://goo.gl/maps/hGnMS2aFda8B7P7P7">Université de Bourgogne</a>
                          </span>
                        </div>
                      </div>
                      ...
                      <div className="line">
                        ...
                        <div className="infos">
                          ...
                          <span>
                            <MapPinIcon/>
                            <a rel="noopener noreferrer" target="_blank" href="https://goo.gl/maps/RK9ojjjpT6Md3dk56">Lycée Général Jean-Marc Boivin</a>
                          </span>
                        </div>
                        <p className="description">
                    ...
                    <Col xs="12" sm="7">
                      <div className="line">
                        ...
                        <div className="infos">
                          ...
                          <span>
                            <MapPinIcon/>
                            <a rel="noopener noreferrer" target="_blank" href="https://goo.gl/maps/svYtwecqZ1TkGBW5A">Bertin Technologies Aix-en-Provence</a>
                          </span>
                        </div>
                        <p className="description">
                      ...
                      <div className="line">
                        ...
                        <div className="infos">
                          <span>
                            <CalendarIcon/>
                            8 Avril - 4 Juillet 2019
                          </span>
                          <br/>
                          <span>
                            <MapPinIcon/>
                            <a rel="noopener noreferrer" target="_blank" href="https://goo.gl/maps/yCfz9tZkP1nJ8BMn6">Bangkok University CROCCS</a>
                          </span>
                        </div>
                        ...
                        <div className="infos">
                          <FileTextIcon/>
                          <a rel="noopener noreferrer" href={require("../../media/recommendations/Recommendation_Suthaputchakun.pdf")} target="_blank">Lettre de recommandation</a>
                        </div>
                      </div>
                    </Col>
                  </Row>
                    ...
                    <Col xs="12" sm="7">
                      <div className="line">
                        ...
                        <div className="infos">
                          ...
                          <span>
                            <MapPinIcon/>
                            <a rel="noopener noreferrer" target="_blank" href="https://goo.gl/maps/THhr4Rq8SMyNFT3a9">École d'ingénieurs ESIREM</a>
                          </span>
                        </div>
                        <p className="description">
                      ...
                      <div className="line">
                        ...
                        <div className="infos">
                          ...
                          <span>
                            <MapPinIcon/>
                            <a rel="noopener noreferrer" target="_blank" href="https://goo.gl/maps/ofRog3EdvES5W3gU8">IUT d'Auxerre</a>
                          </span>
                        </div>
                        <p className="description">
                      ...
                      <div className="line">
                        ...
                        <div className="infos">
                          ...
                          <span>
                            <MapPinIcon/>
                            <a rel="noopener noreferrer" target="_blank" href="https://goo.gl/maps/FtXPq9JNXVm5K1TC7">IUT de Dijon</a>
                          </span>
                        </div>
                        <p className="description">
